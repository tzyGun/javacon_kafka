...
public class City extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public City(java.lang.String cityname, java.lang.String voivodeship, java.util.List<com.ctech.consumer1.WeatherData> weatherDatas) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: weatherDatas = (java.util.List<com.ctech.consumer1.WeatherData>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.ctech.consumer1.WeatherData> getWeatherDatas() {
    return weatherDatas;
  }
   ...
   * @param value the value to set.
   */
  public void setWeatherDatas(java.util.List<com.ctech.consumer1.WeatherData> value) {
   ...
   */
  public static com.ctech.consumer1.City.Builder newBuilder() {
    return new com.ctech.consumer1.City.Builder();
  }
   ...
   * @return A new City RecordBuilder
   */
  public static com.ctech.consumer1.City.Builder newBuilder(com.ctech.consumer1.City.Builder other) {
    return new com.ctech.consumer1.City.Builder(other);
  }
   ...
   * @return A new City RecordBuilder
   */
  public static com.ctech.consumer1.City.Builder newBuilder(com.ctech.consumer1.City other) {
    return new com.ctech.consumer1.City.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<City>
    ...
    private java.util.List<com.ctech.consumer1.WeatherData> weatherDatas;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ctech.consumer1.City.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ctech.consumer1.City other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.cityname)) {
        this.cityname = data().deepCopy(fields()[0].schema(), other.cityname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.consumer1.City.Builder setCityname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.consumer1.City.Builder clearCityname() {
      cityname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.consumer1.City.Builder setVoivodeship(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.consumer1.City.Builder clearVoivodeship() {
      voivodeship = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.consumer1.City.Builder setWeatherDatas(java.util.List<com.ctech.consumer1.WeatherData> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.consumer1.City.Builder clearWeatherDatas() {
      weatherDatas = null;
    ...
    public City build() {
      try {
        ...
        record.weatherDatas = fieldSetFlags()[2] ? this.weatherDatas : (java.util.List<com.ctech.consumer1.WeatherData>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
