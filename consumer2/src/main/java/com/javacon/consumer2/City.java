...
public class City extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<WeatherData> weatherDatas;
   ...
   */
  public City(java.lang.String cityname, java.lang.String voivodeship, java.util.List<WeatherData> weatherDatas) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: weatherDatas = (java.util.List<WeatherData>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<WeatherData> getWeatherDatas() {
    return weatherDatas;
  }
   ...
   * @param value the value to set.
   */
  public void setWeatherDatas(java.util.List<WeatherData> value) {
   ...
   */
  public static City.Builder newBuilder() {
   ...
   * @return A new City RecordBuilder
   */
  public static City.Builder newBuilder(City.Builder other) {
    return new City.Builder(other);
  }
   ...
   * @return A new City RecordBuilder
   */
  public static City.Builder newBuilder(City other) {
    return new City.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<City>
    ...
    private java.util.List<WeatherData> weatherDatas;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(City.Builder other) {
      super(other);
    ...
    /**
      ...
      * @return This builder.
      */
    public City.Builder setCityname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public City.Builder clearCityname() {
      cityname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public City.Builder setVoivodeship(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public City.Builder clearVoivodeship() {
      voivodeship = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public City.Builder setWeatherDatas(java.util.List<WeatherData> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public City.Builder clearWeatherDatas() {
      weatherDatas = null;
    ...
    public City build() {
      try {
        ...
        record.weatherDatas = fieldSetFlags()[2] ? this.weatherDatas : (java.util.List<WeatherData>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
