...
public class WeatherData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3599802411737704827L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"WeatherData\",\"namespace\":\"com.tech3camp.consumer2\",\"fields\":[{\"name\":\"temperature\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"pressure\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"message\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.tech3camp.consumer2.WeatherData.Builder newBuilder() {
    return new com.tech3camp.consumer2.WeatherData.Builder();
  }
   ...
   * @return A new WeatherData RecordBuilder
   */
  public static com.tech3camp.consumer2.WeatherData.Builder newBuilder(com.tech3camp.consumer2.WeatherData.Builder other) {
    return new com.tech3camp.consumer2.WeatherData.Builder(other);
  }
   ...
   * @return A new WeatherData RecordBuilder
   */
  public static com.tech3camp.consumer2.WeatherData.Builder newBuilder(com.tech3camp.consumer2.WeatherData other) {
    return new com.tech3camp.consumer2.WeatherData.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WeatherData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.tech3camp.consumer2.WeatherData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.tech3camp.consumer2.WeatherData other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.temperature)) {
        this.temperature = data().deepCopy(fields()[0].schema(), other.temperature);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech3camp.consumer2.WeatherData.Builder setTemperature(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech3camp.consumer2.WeatherData.Builder clearTemperature() {
      temperature = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech3camp.consumer2.WeatherData.Builder setPressure(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech3camp.consumer2.WeatherData.Builder clearPressure() {
      pressure = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech3camp.consumer2.WeatherData.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.tech3camp.consumer2.WeatherData.Builder clearMessage() {
      message = null;
