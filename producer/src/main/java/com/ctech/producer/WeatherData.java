...
public class WeatherData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.ctech.producer.WeatherData.Builder newBuilder() {
    return new com.ctech.producer.WeatherData.Builder();
  }
   ...
   * @return A new WeatherData RecordBuilder
   */
  public static com.ctech.producer.WeatherData.Builder newBuilder(com.ctech.producer.WeatherData.Builder other) {
    return new com.ctech.producer.WeatherData.Builder(other);
  }
   ...
   * @return A new WeatherData RecordBuilder
   */
  public static com.ctech.producer.WeatherData.Builder newBuilder(com.ctech.producer.WeatherData other) {
    return new com.ctech.producer.WeatherData.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WeatherData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ctech.producer.WeatherData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ctech.producer.WeatherData other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.temperature)) {
        this.temperature = data().deepCopy(fields()[0].schema(), other.temperature);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.producer.WeatherData.Builder setTemperature(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.producer.WeatherData.Builder clearTemperature() {
      temperature = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.producer.WeatherData.Builder setPressure(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.producer.WeatherData.Builder clearPressure() {
      pressure = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.producer.WeatherData.Builder setMessage(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ctech.producer.WeatherData.Builder clearMessage() {
      message = null;
