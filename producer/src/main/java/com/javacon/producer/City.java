...
public class City extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public City(java.lang.String cityname, java.lang.String voivodeship, java.util.List<com.javacon.producer.WeatherData> weatherDatas) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: weatherDatas = (java.util.List<com.javacon.producer.WeatherData>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<com.javacon.producer.WeatherData> getWeatherDatas() {
    return weatherDatas;
  }
   ...
   * @param value the value to set.
   */
  public void setWeatherDatas(java.util.List<com.javacon.producer.WeatherData> value) {
   ...
   */
  public static com.javacon.producer.City.Builder newBuilder() {
    return new com.javacon.producer.City.Builder();
  }
   ...
   * @return A new City RecordBuilder
   */
  public static com.javacon.producer.City.Builder newBuilder(com.javacon.producer.City.Builder other) {
    return new com.javacon.producer.City.Builder(other);
  }
   ...
   * @return A new City RecordBuilder
   */
  public static com.javacon.producer.City.Builder newBuilder(com.javacon.producer.City other) {
    return new com.javacon.producer.City.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<City>
    ...
    private java.util.List<com.javacon.producer.WeatherData> weatherDatas;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.javacon.producer.City.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.javacon.producer.City other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.cityname)) {
        this.cityname = data().deepCopy(fields()[0].schema(), other.cityname);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javacon.producer.City.Builder setCityname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javacon.producer.City.Builder clearCityname() {
      cityname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javacon.producer.City.Builder setVoivodeship(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javacon.producer.City.Builder clearVoivodeship() {
      voivodeship = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javacon.producer.City.Builder setWeatherDatas(java.util.List<com.javacon.producer.WeatherData> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javacon.producer.City.Builder clearWeatherDatas() {
      weatherDatas = null;
    ...
    public City build() {
      try {
        ...
        record.weatherDatas = fieldSetFlags()[2] ? this.weatherDatas : (java.util.List<com.javacon.producer.WeatherData>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
